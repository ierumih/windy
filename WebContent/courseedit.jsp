 ...
 <body>
	...
	<div id = "wrap">
				...
				<div class="body">
					...
					-->
					<form name="tx_editor_form" id="tx_editor_form" action="courseboardedit.b?c_num=<%=course.getC_num()%>" method="post" accept-charset="utf-8">
						<div id="titlebox">
							<input type = "text" id = "title" name = "title" placeholder = "제목 입력" value = <%=course.getC_name() %>>
						</div>
						<!-- 에디터 컨테이너 시작 -->
...
<!-- 						<div style="text-align: right;">
				...
				<textarea id = "loadcont" style="display:none"><%=course.getC_cont()%></textarea>
				<!-- Saving Contents -->
				<script type="text/javascript">
					/* 예제용 함수 */
