...
<body>
	<form name="info" action="team_join.jsp" method="post" accept-charset="UTF-8">
		<div id = "wrapper">
	 	<header>
			<div id = "headt">
				<a href = "main.jsp">
		...
		<main>
			<article>
				...
				<table border="0">
					...
					<tr>
						<th>성별</th>
						<td><input type="radio" name="sex" id="woman" value="여자"> <label for="woman">여자</label>
							<input type="radio" name="sex" id="man" value="남자"> <label for="man">남자</label>
						</td>
					</tr>
					<tr>
						<th>주소</th>
