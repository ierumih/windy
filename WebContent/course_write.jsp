 ...
 <body>
	...
	<div id = "wrap">
				...
				<div class="body">
					...
					-->
					<form name="tx_editor_form" id="tx_editor_form" action="coursewriteaction.b" method="post" accept-charset="utf-8">
						<div id="titlebox">
										...
										<div id="tx_richtextbox_menu" class="tx-richtextbox-menu tx-menu">
											...
											<div class="tx-menu-footer">
												<img class="tx-menu-confirm"
													 src="DaumEditor-master/daumeditor/images/icon/editor/btn_confirm.gif?rv=1.0.1" alt=""/>
												<img class="tx-menu-cancel" hspace="3"
													 src="DaumEditor-master/daumeditor/images/icon/editor/btn_cancel.gif?rv=1.0.1" alt=""/>
											</div>
										</div>
									</li>
									<li class="tx-list">
					...
					<div id="tx_canvas" class="tx-canvas">
						<div id="tx_loading" class="tx-loading"><div><img src="DaumEditor-master/daumeditor/images/icon/editor/loading2.png" width="113" height="21" align="absmiddle"/></div></div>
					...
					<div id="tx_resizer" class="tx-resize-bar">
						...
						<img id="tx_resize_holder" src="DaumEditor-master/daumeditor/images/icon/editor/skin/01/btn_drag01.gif" width="58" height="12" unselectable="on" alt="" />
					</div>
									<div class="tx-side-bi" id="tx_side_bi">
<!-- 						<div style="text-align: right;">
							<img hspace="4" height="14" width="78" align="absmiddle" src="DaumEditor-master/daumeditor/images/icon/editor/editor_bi.png" />
						</div> -->
					</div>
								<!-- 편집영역 끝 -->
							<!-- 첨부박스 시작 -->
					...
					<div id="tx_attach_div" class="tx-attach-div">
						...
						<div id="tx_attach_box" class="tx-attach-box">
							<div class="tx-attach-box-inner">
								<div id="tx_attach_preview" class="tx-attach-preview"><p></p><img src="DaumEditor-master/daumeditor/images/icon/editor/pn_preview.gif" width="147" height="108" unselectable="on"/></div>
						...
						주소 입력&nbsp<input type = "text" name = "c_location" id = "c_location">
					</form>
				</div>
				<!-- 에디터 끝 -->
				<script type="text/javascript">
					var config = {
						...
						size: {
							contentWidth: 1080 /* 지정된 본문영역의 넓이가 있을 경우에 설정 */
						}
					};
				...
				<script type="text/javascript">
					...
					function setForm(editor) {
				        ...
				        var content = editor.getContent();
				        var c_area = $("#ssel option:selected").val();
				        var c_location = document.getElementById('c_location');
		                ...
		                input.type = 'hidden';
		                input.name = 'c_location';
		                input.value = c_location;
				        ...
				        for (i = 0; i < images.length; i++) {
			                ...
			                input.type = 'hidden';
			                input.name = 'attach_image';
			                input.value = imgs;  // 예에서는 이미지경로만 받아서 사용
			                form.createField(input);				            
				        }
